...
ifeq ($(config),debug32)
  ...
  LIBS      += ../../bin/libevdsd32.a ../../bin/libsimcd32.a
...
ifeq ($(config),release32)
  ...
  LDFLAGS   += -L../../bin -m32 -L/usr/lib32
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += ../../bin/libevds32.a ../../bin/libsimc32.a
...
ifeq ($(config),debugdynamic32)
  ...
  LDFLAGS   += -L../../bin -m32 -L/usr/lib32
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += -levdsd32 ../../bin/libsimcd32.a
  LDDEPS    += ../../bin/libevdsd32.a ../../bin/libsimcd32.a
  LINKCMD    = $(CC) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
  define PREBUILDCMDS
  endef
...
ifeq ($(config),debugsinglethread32)
  ...
  LDFLAGS   += -L../../bin -m32 -L/usr/lib32
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += ../../bin/libevds_std32.a ../../bin/libsimc_std32.a
...
ifeq ($(config),releasesinglethread32)
  ...
  LDFLAGS   += -L../../bin -m32 -L/usr/lib32
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += ../../bin/libevds_st32.a ../../bin/libsimc_st32.a
...
ifeq ($(config),debugsinglethreaddynamic32)
  ...
  LDFLAGS   += -L../../bin -m32 -L/usr/lib32
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += -levds_std32 ../../bin/libsimc_std32.a
  LDDEPS    += ../../bin/libevds_std32.a ../../bin/libsimc_std32.a
  LINKCMD    = $(CC) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
  define PREBUILDCMDS
  endef
...
ifeq ($(config),releasesinglethreaddynamic32)
  ...
  LDFLAGS   += -L../../bin -m32 -L/usr/lib32
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += -levds_st32 ../../bin/libsimc_st32.a
  LDDEPS    += ../../bin/libevds_st32.a ../../bin/libsimc_st32.a
  LINKCMD    = $(CC) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
  define PREBUILDCMDS
  endef
...
ifeq ($(config),debug64)
  ...
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += ../../bin/libevdsd.a ../../bin/libsimcd.a
...
ifeq ($(config),release64)
  ...
  LDFLAGS   += -L../../bin -m64 -L/usr/lib64
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += ../../bin/libevds.a ../../bin/libsimc.a
...
ifeq ($(config),debugsinglethread64)
  ...
  LDFLAGS   += -L../../bin -m64 -L/usr/lib64
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += ../../bin/libevds_std.a ../../bin/libsimc_std.a
...
ifeq ($(config),releasesinglethread64)
  ...
  LDFLAGS   += -L../../bin -m64 -L/usr/lib64
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += ../../bin/libevds_st.a ../../bin/libsimc_st.a
...
ifeq ($(config),debugsinglethreaddynamic64)
  ...
  LDFLAGS   += -L../../bin -m64 -L/usr/lib64
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += -levds_std ../../bin/libsimc_std.a
  LDDEPS    += ../../bin/libevds_std.a ../../bin/libsimc_std.a
  LINKCMD    = $(CC) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
  define PREBUILDCMDS
  endef
...
ifeq ($(config),releasesinglethreaddynamic64)
  ...
  LDFLAGS   += -L../../bin -m64 -L/usr/lib64
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += -levds_st ../../bin/libsimc_st.a
  LDDEPS    += ../../bin/libevds_st.a ../../bin/libsimc_st.a
  LINKCMD    = $(CC) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
  define PREBUILDCMDS
  endef
...
$(OBJDIR)/evds_tutorials.o: ../../source/evds_tutorials/evds_tutorials.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
