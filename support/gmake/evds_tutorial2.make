...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/evds_tutorial2
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/evds_tutorial2d32
  DEFINES   += -DDEBUG
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/evds_tutorial2
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/evds_tutorial232
  DEFINES   += 
  INCLUDES  += -I../../include -I../../external/simc/include -I../../tutorials
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debugdynamic32)
  OBJDIR     = obj/x32/DebugDynamic/evds_tutorial2
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/evds_tutorial2d32
...
ifeq ($(config),releasedynamic32)
  OBJDIR     = obj/x32/ReleaseDynamic/evds_tutorial2
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/evds_tutorial232
...
ifeq ($(config),debugsinglethread32)
  OBJDIR     = obj/x32/DebugSingleThread/evds_tutorial2
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/evds_tutorial2_std32
...
ifeq ($(config),releasesinglethread32)
  OBJDIR     = obj/x32/ReleaseSingleThread/evds_tutorial2
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/evds_tutorial2_st32
...
ifeq ($(config),debugsinglethreaddynamic32)
  OBJDIR     = obj/x32/DebugSingleThreadDynamic/evds_tutorial2
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/evds_tutorial2_std32
...
ifeq ($(config),releasesinglethreaddynamic32)
  OBJDIR     = obj/x32/ReleaseSingleThreadDynamic/evds_tutorial2
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/evds_tutorial2_st32
...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/evds_tutorial2
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/evds_tutorial2d
  DEFINES   += -DDEBUG
  INCLUDES  += -I../../include -I../../external/simc/include -I../../tutorials
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/evds_tutorial2
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/evds_tutorial2
  DEFINES   += 
  INCLUDES  += -I../../include -I../../external/simc/include -I../../tutorials
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debugdynamic64)
  OBJDIR     = obj/x64/DebugDynamic/evds_tutorial2
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/evds_tutorial2d
  DEFINES   += -DDEBUG -DEVDS_DYNAMIC -DIVSS_DYNAMIC -DRDRS_DYNAMIC -DSIMC_DYNAMIC
  INCLUDES  += -I../../include -I../../external/simc/include -I../../tutorials
...
ifeq ($(config),releasedynamic64)
  OBJDIR     = obj/x64/ReleaseDynamic/evds_tutorial2
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/evds_tutorial2
  DEFINES   += -DEVDS_DYNAMIC -DIVSS_DYNAMIC -DRDRS_DYNAMIC -DSIMC_DYNAMIC
  INCLUDES  += -I../../include -I../../external/simc/include -I../../tutorials
...
ifeq ($(config),debugsinglethread64)
  OBJDIR     = obj/x64/DebugSingleThread/evds_tutorial2
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/evds_tutorial2_std
  DEFINES   += -DDEBUG -DEVDS_SINGLETHREADED -DIVSS_SINGLETHREADED -DRDRS_SINGLETHREADED -DSIMC_SINGLETHREADED
  INCLUDES  += -I../../include -I../../external/simc/include -I../../tutorials
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) $(ARCH) -g -m64
...
ifeq ($(config),releasesinglethread64)
  OBJDIR     = obj/x64/ReleaseSingleThread/evds_tutorial2
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/evds_tutorial2_st
  DEFINES   += -DEVDS_SINGLETHREADED -DIVSS_SINGLETHREADED -DRDRS_SINGLETHREADED -DSIMC_SINGLETHREADED
  INCLUDES  += -I../../include -I../../external/simc/include -I../../tutorials
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) $(ARCH) -O2 -g -m64
...
ifeq ($(config),debugsinglethreaddynamic64)
  OBJDIR     = obj/x64/DebugSingleThreadDynamic/evds_tutorial2
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/evds_tutorial2_std
  DEFINES   += -DDEBUG -DEVDS_DYNAMIC -DIVSS_DYNAMIC -DRDRS_DYNAMIC -DSIMC_DYNAMIC -DEVDS_SINGLETHREADED -DIVSS_SINGLETHREADED -DRDRS_SINGLETHREADED -DSIMC_SINGLETHREADED
  INCLUDES  += -I../../include -I../../external/simc/include -I../../tutorials
...
ifeq ($(config),releasesinglethreaddynamic64)
  OBJDIR     = obj/x64/ReleaseSingleThreadDynamic/evds_tutorial2
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/evds_tutorial2_st
  DEFINES   += -DEVDS_DYNAMIC -DIVSS_DYNAMIC -DRDRS_DYNAMIC -DSIMC_DYNAMIC -DEVDS_SINGLETHREADED -DIVSS_SINGLETHREADED -DRDRS_SINGLETHREADED -DSIMC_SINGLETHREADED
  INCLUDES  += -I../../include -I../../external/simc/include -I../../tutorials
...
$(OBJDIR)/evds_tutorial2.o: ../../tutorials/evds_tutorial2.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
